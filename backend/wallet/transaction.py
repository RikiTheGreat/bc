...
class Transaction:
    """
    Document of an excahnge in currency from a sender to one
    or more recipients.
    """
    ...
    def update(self, sender_wallet, recipient, amount):
        """
        Update the tranaction with an existing or new recipient.
        """
    ...
    def to_json(self):
        """
        Serialize Transaction class for json.
        """
    ...
    def from_json(json_object):
        """
        Convert json model of a transaction back into Transaction instance form.
        """

        return Transaction(**json_object)
    ...
    def validate_transaction(transaction):
        ...
        # mining reward transacion output must only has one entry with
        # valid MINING_REWARD value
